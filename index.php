        ...
        <div class="col-md-6 offset-md-3">
            ...
            <div class="card my-3">
                <div class="card-body">
                    ...
                    <p class="card-text">Email автора: <?= htmlspecialchars($message['email']) ?></p>
...
<?php else: ?>
    ...
    <div class="row">
        <div class="col-md-6 offset-md-3">
            <p>Добро пожаловать, <?php echo htmlspecialchars($_SESSION['user']['name']); ?>! <a href="?do=exit">Log out</a></p>
        </div>
    </div>
